...
export async function executeSessionManager(args: ToolArguments, onProgress?: (newOutput: string) => void): Promise<string> {
  const typedArgs = args as z.infer<typeof sessionManagerSchema.inputSchema>;
